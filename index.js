...
function makeBun(){
  var updateBunStatus = updateStatus.bind(this);
  updateBunStatus("Prep")
  bun.decorate = cake.decorate.bind(bun);
  mix.call(bun, updateBunStatus)
}
...
function makeDessert() {
  ...
  } else if (this.parentNode.id == "bun"){
    makeBun.call(this.parentNode);
  } else {
